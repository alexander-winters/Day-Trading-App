...
async function commit_buy(user) {
    ...
    try {
        ...
        console.error("Error in commit_buy:", error);
    }
}
...
async function cancel_buy(user) {
    ...
    try {
        ...
        console.error("Error in cancel_buy:", error);
    }   
}
...
async function set_buy_amount(user, stock_symbol, amount) {
    ...
    try {
        ...
        console.error("Error in set_buy_amount:", error);
    }
}
...
async function set_buy_trigger(user, stock_symbol, amount) {
    ...
    try {
        ...
        console.error("Error in set_buy_trigger:", error);
    }
}
...
async function cancel_set_buy(user, stock_symbol) {
    ...
    try {
        ...
        console.error("Error in cancel_set_buy:", error)
    }
}
